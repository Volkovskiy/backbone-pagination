...
/***/ function(module, exports, __webpack_require__) {
	...
	var _backgrid = __webpack_require__(4);
	...
	var _pageResize = __webpack_require__(8);
	...
	// libraries
	var paginator = new _backgrid2.default.Extension.Paginator({ collection: _Items2.default, windowSize: 3 });

	//import modules


	_Items2.default.fetch();

	(0, _jquery2.default)("#grid").append(_grid2.default.render().$el);
	(0, _jquery2.default)("#paginator").append(paginator.render().$el);
	(0, _jquery2.default)("#pageResizer").append(_pageResize2.default.render().el);
	...
	*/
	...
	(function (root, factory) {
	  ...
	  if (true) {
	    ...
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(3), __webpack_require__(2)], __WEBPACK_AMD_DEFINE_RESULT__ = function (_, Backbone) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _backgridPaginator = __webpack_require__(6);

	var _backgridPaginator2 = _interopRequireDefault(_backgridPaginator);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var Items = _backbone2.default.PageableCollection.extend({
		mode: 'client',
		url: "../json/items.json",
		state: {
			firstPage: 1,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PageResize = _backbone2.default.View.extend({
		tagName: 'select',
		className: 'ps-select',
		render: function render() {
			...
			this.collection.forEach(function (option) {
				_this.$el.append('<option>' + option + ' per page</option>');
			});
			return this;
		},
		events: {
		...
		setPageSize: function setPageSize(e) {
			_grid2.default.collection.state.pageSize = parseInt(e.currentTarget.value);
			_grid2.default.collection.reset();
			_grid2.default.collection.getPage(1);
		}
	});

	var pageResize = new PageResize({
		collection: _Items2.default.pageSizeValues
	});

	exports.default = pageResize;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DeletableRow = __webpack_require__(10);

	var _DeletableRow2 = _interopRequireDefault(_DeletableRow);
	...
	var grid = new _backgrid2.default.Grid({
		row: _DeletableRow2.default,
		columns: _columns2.default,
		collection: _Items2.default
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DeletableRow = _backgrid2.default.Row.extend({
		events: {
			click: "deleteRow"
		},
